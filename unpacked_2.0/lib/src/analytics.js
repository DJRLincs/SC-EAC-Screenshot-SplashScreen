...
const sendAnalytics = (info, mainWindow) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => {
        ...
        const payload = Object.assign(Object.assign({}, data), { Product: 'launcher', OperatingSystem: `Windows ${os_1.default.release()}`, LauncherVersion: (data === null || data === void 0 ? void 0 : data.LauncherVersion) || packageJsonFile_1.version, PatcherVersion: (data === null || data === void 0 ? void 0 : data.PatcherVersion) || patcherVersion, AccountName: accountName || 'Unknown', HeapAccountID: heapAccountId || -1, TMId: trackingMetricsId || -1, Event: name });
