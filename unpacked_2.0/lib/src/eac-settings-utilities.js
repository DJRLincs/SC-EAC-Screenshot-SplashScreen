...
function isAvailable(gameDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const EACDirectory = getAntiCheatDirectory(gameDirectory);
            yield promises_1.default.access(EACDirectory);
            return true;
        }
        catch (e) {
            return false;
...
function readSettings(gameDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
