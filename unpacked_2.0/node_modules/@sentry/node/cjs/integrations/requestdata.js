   ...
   */
   setupOnce(addGlobalEventProcessor, getCurrentHub) {
    ...
    addGlobalEventProcessor(event => {
      ...
      var self = hub.getIntegration(RequestData);
      var req = event.sdkProcessingMetadata && event.sdkProcessingMetadata.request;
      ...
      var processedEvent = addRequestData(event, req, { include: formatIncludeOption(include) });
      ...
      var reqWithTransaction = req ;
      var transaction = reqWithTransaction._sentryTransaction;
      if (transaction) {
        // TODO (v8): Remove the nextjs check and just base it on `transactionNamingScheme` for all SDKs. (We have to
        // keep it the way it is for the moment, because changing the names of transactions in Sentry has the potential
        // to break things like alert rules.)
        var shouldIncludeMethodInTransactionName =
