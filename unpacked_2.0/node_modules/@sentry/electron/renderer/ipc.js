...
function getImplementation() {
    ...
    fetch(`${common_1.PROTOCOL_SCHEME}://${common_1.IPCChannel.PING}/sentry_key`).catch(() => console.error(`Sentry SDK failed to establish connection with the Electron main process.
