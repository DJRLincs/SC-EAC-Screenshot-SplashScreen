const configuration = {
  ...
  copyPTUAccountSupportUrl:
    'https://support.robertsspaceindustries.com/hc/en-us/articles/360000668488-Install-the-Star-Citizen-PTU',
  ...
  minimumRequirementsUrl:
    'https://support.robertsspaceindustries.com/hc/en-us/articles/360042417374-Star-Citizen-Minimum-System-Requirements',
  filesSupportUrl:
    'https://support.robertsspaceindustries.com/hc/en-us/articles/360000065688-Send-In-Game-Files-for-RSI-Support',
  ...
  carousel: {
    delay: 25000,
    images: [
      '/images/carousel-slide-1@2x.jpg',
      '/images/carousel-slide-2@2x.jpg',
      '/images/carousel-slide-3@2x.jpg',
      '/images/carousel-slide-4@2x.jpg',
    ],
  },
  loginDataRemovalTimeout: 5 * 60 * 1000, // 5 minutes
  statusDataRefreshInterval: 60 * 1000, // 1 minute
  appLayoutLoaderWipeTrigger: 2500, // Force the main app loading screen to show for at least 3 seconds
};
