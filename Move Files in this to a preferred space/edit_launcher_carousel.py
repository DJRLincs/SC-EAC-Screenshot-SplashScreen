...
npx_command = ["npx", "asar", "extract", "app.asar", "unpacked"]
# npx_command = ["echo", "Hello World!"]  # for testing subprocess
...
if not (path / "unpacked").exists():
    # Run the command
    process = subprocess.Popen(npx_command, cwd=path, shell=True)
